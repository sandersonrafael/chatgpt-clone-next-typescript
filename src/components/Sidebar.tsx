...
export default function Sidebar({ children, open, onClose, onClear, onNewChat }: Props) {
  return (
    <section
      className={`
      ...
      `}>
        ...
        <div className="flex flex-col w-64 p-2 bg-gray-900">
          ...
          <div onClick={onNewChat} className="
            flex items-center p-3 rounded-md text-sm cursor-pointer
